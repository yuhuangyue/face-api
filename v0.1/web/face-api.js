(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  function createCanvasFromMedia(media, dims) {
      var img_array = new Array(200).fill(0).map(() => new Array(200).fill(0).map(() => new Array(3).fill(0)))
      ...
      if (media instanceof ImageData) {
          ...
          const data = getContext2dOrThrow(canvas).getImageData(0, 0, width, height).data;
